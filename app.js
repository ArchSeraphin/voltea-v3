  ...
  helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        styleSrc: ["'self'", "'unsafe-inline'", 'https://fonts.googleapis.com', 'https://leadbooster-chat.pipedrive.com', 'https://*.pipedriveassets.com'],
        fontSrc: ["'self'", 'https://fonts.gstatic.com', 'https://*.pipedriveassets.com'],
        imgSrc: ["'self'", 'data:', 'https://www.google-analytics.com', 'https://www.googletagmanager.com', 'https://leadbooster-chat.pipedrive.com', 'https://*.pipedriveassets.com'],
        connectSrc: [
          "'self'",
          'https://www.google-analytics.com',
